...
@section('content-account')
    <div class="col-span-9 space-y-4">
        @foreach ($order->orderItems as $orderItem)
            <div class="flex items-center justify-between border gap-12 p-4 border-gray-200 rounded">
                <div class="w-28">
                    ...
                    @endphp
                    <img src='{{ asset("uploads/$user->username/$product_name/$product_image") }}' alt="{{ $orderItem->product->name }}" class="w-full">
                </div>
                <div class="w-1/3">
        ...
        @endforeach
            ...
            <button type="submit" class="my-5 w-full bg-neon-blue text-black border font-bold py-2 px-4 rounded-full border-black">
                Pay
            </button>
